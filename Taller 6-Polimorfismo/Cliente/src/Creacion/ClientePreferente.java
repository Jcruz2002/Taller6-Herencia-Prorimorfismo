...
public class ClientePreferente extends Cliente{
    ...
    public ClientePreferente (int inf, long Ncu,double sald,int fondo){
      ...
      super(inf,Ncu,sald);
      this.NFondos = fondo;
      this.Fond = new Fondo[this.NFondos];
      this.n=0;
     ...
     */
    public void setFond(Fondo[] Fond) {
        this.Fond = Fond;
    }
    ...
    public String toString(){
        ...
        return  "NIF             : "+super.getNIF()+"\n"+
                "Numero de Cuenta: "+super.getNumeroCuenta()+"\n"+
